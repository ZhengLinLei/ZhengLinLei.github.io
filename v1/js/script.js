window.onload = function () {
    ...
    const popup = document.getElementById('paperModePopup');
    const closeBtn = document.getElementById('closePopupBtn');
    if (sessionStorage.getItem('paperPopupShown')) return;
    ...
    if (closeBtn) {
        closeBtn.addEventListener('click', () => {
            ...
            sessionStorage.setItem('paperPopupShown', 'true');
        });
    }
};
